    ...
    return (
        <section id="products-section" className="container mx-auto mt-32">
            ...
            <div className="grid grid-cols-4 gap-5">
                ...
                <Link href={`/product/${product.name}`} key={index} className="p-1.5">
                    ...
                    <h3 className="font-medium text-lg mb-1.5 mt-4 bg-white hover:drop-shadow-xl duration-300">{product.name}</h3>
